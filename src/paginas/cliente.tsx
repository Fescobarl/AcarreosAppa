...
function Cliente() {
  ...
  return (
    <>
    <head><link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@3.4.1/dist/css/bootstrap.min.css"/></head>
    ...
    <div className='main-container'>
      <div className='guide-number'>
        ...
        <input type="number" className='guide' placeholder='Ingrese su número de guía' />
      </div>
