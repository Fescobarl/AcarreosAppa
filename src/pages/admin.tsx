      ...
      <body className='body-cliente'>
        <div className={`container ${isOpen ? '' : 'sidebar-hidden'}`}>
          ...
          <aside className={`sidebar ${isOpen ? '' : 'hidden'}`} id='sidebar'>
            <img src={arrow} alt="arrow left" onClick={openCloseSidebar} className={`arrow ${isOpen ? '' : 'hidden'}`} />
          ...
          <main className='content'>
            <section className='search-section'>
              {!isOpen && <img src={arrow2} alt="arrow right" onClick={openCloseSidebar} className='arrow-open' />}
